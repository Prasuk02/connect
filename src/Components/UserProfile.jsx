    ...
    return (
        <>
            ...
            <Stack direction='row'>
                ...
                {/* post section */}
                <Box width='82%' p='10px 82px'>
                    <Stack pl='40px' pr='27px' py='30px' mt='20px' direction='row' spacing={5} alignItems='flex-start' backgroundColor= "white" borderRadius='10px'>
                        <Box pt='7px'>
                            <Avatar src={userProfileData?.profilePic} style={{width: '140px', height: '140px'}}/>
                        </Box>
